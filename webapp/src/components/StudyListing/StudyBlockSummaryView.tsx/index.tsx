      ...
      <Card className={classes.root}>
        ...
        <CardActions>
          <div style={{ width: '100%' }}>
            ...
            <DownloadLink name={study.name} url={getExportUrl(study.id, true, false)}><Button size="small" style={{ color: theme.palette.primary.light }}>{t('main:export')}</Button></DownloadLink>
            <DownloadLink name={study.name} url={getExportUrl(study.id, false, false)}><Button size="small" style={{ color: theme.palette.primary.light }}>{t('main:archive')}</Button></DownloadLink>
